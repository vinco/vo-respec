VO-ReSpec
=========
[![Build Status](https://travis-ci.org/vinco/vo-respec.svg?branch=develop)](https://travis-ci.org/vinco/vo-respec)
...
of writing Vinco Orbis specifications, but has since grown to be able to support other outputs as 
well.

VO-ReSpec is a fork of [ReSpec][respec] from [W3C][w3c].

Important Note
==============

ReSpec is not endorsed by Vinco Orbis and nobody should expect the Vinco Orbis Webmaster to provide advice on 
